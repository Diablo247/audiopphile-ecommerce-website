...
export interface AlsoLike {
  img: string;
  name: string;
  href: string; // could be slug or product id
}

export interface Product {
  id: string;
  slug?: string; // optional since not all have this
  name: string;
  description: string;
...
export const products: Product[] = [
  {
    ...
    alsoLike: [
      { img: "/img2.svg", name: "XX99 MARK I", href: "/product/2" },
      { img: "/img3.svg", name: "XX59", href: "/product/3" },
      { img: "/img4.svg", name: "ZX9 SPEAKER", href: "/product/4" },
    ],
  },
  {
    id: "2",
    ...
    alsoLike: [
      { img: "/img1.svg", name: "XX99 MARK II", href: "/product/1" },
      { img: "/img3.svg", name: "XX59", href: "/product/3" },
      { img: "/img4.svg", name: "ZX9 SPEAKER", href: "/product/4" },
    ],
  },
  ...
  },
  {
    ...
    alsoLike: [
      { img: "/img5.svg", name: "ZX7 SPEAKER", href: "/product/5" },
      { img: "/img2.svg", name: "XX99 MARK I", href: "/product/2" },
      { img: "/img3.svg", name: "XX59", href: "/product/3" },
    ],
  },
